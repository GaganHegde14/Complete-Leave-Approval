          ...
          <div className={styles.tableHeader}>
            <div className={styles.headerContainer}>
              <div className={styles.headerRow}>
                ...
                <div 
                  className={`${styles.headerCell} ${styles.ExpectedDeliveryDateCol}`}
                  onClick={() => handleSort('ExpectedDeliveryDate')}
                >
                  <span className={styles.headerLabel}>Expected Delivery Date</span>
                </div>
                <div 
                ...
                <div 
                  className={`${styles.headerCell} ${styles.AttratchmentCol}`}
                  onClick={() => handleSort('Attrachment')}
                >
                  <span className={styles.headerLabel}>Attachment</span>
                </div>
              </div>
            </div>
                ...
                <div className={styles.rowContainer}>
                  <div className={styles.rowGroup}>
                    <div className={styles.cellGroup}>
                      ...
                      <div className={`${styles.dataCell} ${styles.ExpectedDeliveryDateCol}`}>
                        {row.ExpectedDeliveryDate}
                      </div>
                      <div className={`${styles.dataCell} ${styles.noOfDaysCol}`}>
                        {row.noOfDays}
                      </div>
                      <div className={`${styles.dataCell} ${styles.AttratchmentCol}`}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                            <img src={file} alt="file" style={{ width: '30px', height: '30px' }} />
                            <span>{row.Attrachment}</span>
                            <img src={downloadIcon} alt="Download" style={{ width: '30px', height: '30px' }} />
                        </div>
                      </div>
                    </div>
                  </div>
