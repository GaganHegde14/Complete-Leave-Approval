          ...
          <div className={styles.tableHeader}>
            <div className={styles.headerContainer}>
              <div className={styles.headerRow}>
                ...
                <div 
                  className={`${styles.headerCell} ${styles.RelaitonCol}`}
                  onClick={() => handleSort('Relaiton')}
                >
                  <span className={styles.headerLabel}>Relation</span>
                </div>
                <div 
                ...
                <div className={styles.rowContainer}>
                  <div className={styles.rowGroup}>
                    <div className={styles.cellGroup}>
                      ...
                      <div className={`${styles.dataCell} ${styles.RelaitonCol}`}>
                        {row.Relaiton}
                      </div>
