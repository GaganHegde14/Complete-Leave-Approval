          ...
          <div className={styles.tableHeader}>
            <div className={styles.headerContainer}>
              <div className={styles.headerRow}>
                ...
                <div 
                  className={`${styles.headerCell} ${styles.HolidayListCol}`}
                  onClick={() => handleSort('HolidayList')}
                >
                  <span className={styles.headerLabel}>Holiday List</span>
                </div>
                <div 
                ...
                <div className={styles.rowContainer}>
                  <div className={styles.rowGroup}>
                    <div className={styles.cellGroup}>
                      ...
                      <div className={`${styles.dataCell} ${styles.HolidayListCol}`}>
                        {row.HolidayList}
                      </div>
